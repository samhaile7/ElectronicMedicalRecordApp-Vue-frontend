<template>
  <nav class="topbar">
    <router-link to="/dashboard">
      ...
      >
        <g transform="matrix(1,0,0,1,-0.6060560964583033,-0.03499360561035303)">
          <svg
            viewBox="0 0 396 69"
          ...
          >
            <g
              id="tight-bounds"
              transform="matrix(1,0,0,1,0.23999821419749878,0.013876774638589495)"
            >
              <svg viewBox="0 0 395.52 68.97224109331525" height="68.97224109331525" width="395.52">
                <g>
                  <svg
                    viewBox="0 0 395.52 68.97224109331525"
                    height="68.97224109331525"
                    width="395.52"
                  >
                    <g>
                      <svg
                      ...
                      >
                        <g>
                          <svg
                            viewBox="0 0 496.8688222204672 86.64582372052402"
                            height="68.97224109331525"
                            width="395.52"
                          >
                            <g transform="matrix(1,0,0,1,0,11.974929327510921)">
                              <svg
                                viewBox="0 0 395.52 62.69596506550218"
                                height="62.69596506550218"
                                width="395.52"
                              >
                            ...
                            <g transform="matrix(1,0,0,1,410.3210126488035,0)">
                              <svg
                                viewBox="0 0 86.54780957166373 86.64582372052402"
                                height="86.64582372052402"
                                width="86.54780957166373"
                              >
                                <g>
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    x="0"
                                    y="0"
                                    viewBox="6 6.299999237060547 88.29999542236328 88.39999389648438"
                                  ...
                                  >
                                    <g fill="#ffdc00" data-fill-palette-color="accent">
                                      <path
                                        fill="#ffdc00"
                                        d="M62 94.7H38.3c-1.9 0-3.5-1.6-3.5-3.5l-0.2-25.3H9.5c-1.9 0-3.5-1.6-3.5-3.5V38.6c0-1.9 1.6-3.5 3.5-3.5h25l0.3-25.3c0-1.9 1.6-3.5 3.5-3.5H62c1.9 0 3.5 1.6 3.5 3.5S64 13.3 62 13.3H41.7l-0.3 25.3c0 1.9-1.6 3.5-3.5 3.5H13v16.8h25.1c1.9 0 3.5 1.6 3.5 3.5l0.2 25.3h16.8l0.2-25.3c0-1.9 1.6-3.5 3.5-3.5h25.1V42.1H62.3c-1.9 0-3.5-1.5-3.5-3.5l-0.2-14.4c0-1.9 1.5-3.5 3.5-3.5 1.9 0 3.5 1.5 3.5 3.5l0.1 11h25.1c1.9 0 3.5 1.6 3.5 3.5v23.8c0 1.9-1.6 3.5-3.5 3.5H65.7l-0.2 25.3C65.5 93.1 64 94.7 62 94.7z"
                                        data-fill-palette-color="accent"
                                      ></path>
                                    </g>
                                  </svg>
